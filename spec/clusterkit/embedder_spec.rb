...
RSpec.describe ClusterKit::Embedder do
  # Sample test data
  ...
  describe '#initialize' do
    context 'with default parameters' do
      ...
      it 'creates a Config object' do
        expect(embedder.config).to be_a(ClusterKit::Config)
      end
  ...
  describe '#transform' do
    ...
    context 'with unfitted embedder' do
      it 'raises error' do
        ...
        }.to raise_error(ClusterKit::Error, /must be fitted before transform/)
      end
    end
  end
  ...
  describe '#save and .load' do
    ...
    context 'with unfitted embedder' do
      it 'raises error when saving' do
        expect {
          embedder.save(save_path)
        }.to raise_error(ClusterKit::Error, /must be fitted before saving/)
      end
    end
