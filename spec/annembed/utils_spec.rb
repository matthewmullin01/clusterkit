...
RSpec.describe AnnEmbed::Utils do
  # Sample test data
  ...
  describe '.estimate_intrinsic_dimension' do
    context 'with valid data' do
      it 'estimates dimension for simple data' do
        ...
        allow(AnnEmbed::Utils).to receive(:estimate_intrinsic_dimension_rust).and_return(2.5)
        
        result = described_class.estimate_intrinsic_dimension(simple_data)
        expect(result).to eq(2.5)
        expect(AnnEmbed::Utils).to have_received(:estimate_intrinsic_dimension_rust).with(simple_data, 10)
      end
      
      it 'accepts custom k_neighbors parameter' do
        allow(AnnEmbed::Utils).to receive(:estimate_intrinsic_dimension_rust).and_return(3.2)
        
        result = described_class.estimate_intrinsic_dimension(simple_data, k_neighbors: 5)
        expect(result).to eq(3.2)
        expect(AnnEmbed::Utils).to have_received(:estimate_intrinsic_dimension_rust).with(simple_data, 5)
      end
      
      it 'works with high-dimensional data' do
        allow(AnnEmbed::Utils).to receive(:estimate_intrinsic_dimension_rust).and_return(7.8)
        
        result = described_class.estimate_intrinsic_dimension(high_dim_data, k_neighbors: 15)
        expect(result).to be_a(Float)
        expect(AnnEmbed::Utils).to have_received(:estimate_intrinsic_dimension_rust).with(high_dim_data, 15)
      end
    ...
    context 'edge cases' do
      ...
      it 'handles small k_neighbors' do
        allow(AnnEmbed::Utils).to receive(:estimate_intrinsic_dimension_rust).and_return(1.5)
      ...
      it 'handles large k_neighbors' do
        allow(AnnEmbed::Utils).to receive(:estimate_intrinsic_dimension_rust).and_return(4.2)
  ...
  describe '.estimate_hubness' do
    context 'with valid data' do
      it 'estimates hubness for simple data' do
        ...
        allow(AnnEmbed::Utils).to receive(:estimate_hubness_rust).and_return(mock_result)
        ...
        expect(AnnEmbed::Utils).to have_received(:estimate_hubness_rust).with(simple_data)
      end
    ...
    context 'edge cases' do
      ...
      it 'handles identical points' do
        ...
        allow(AnnEmbed::Utils).to receive(:estimate_hubness_rust).and_return({ 'mean_hub_score' => 0.0 })
  ...
  describe 'integration tests' do
    context 'with real data flow' do
      ...
      it 'can estimate dimension and hubness for same dataset' do
        ...
        allow(AnnEmbed::Utils).to receive(:estimate_intrinsic_dimension_rust).and_return(3.5)
        allow(AnnEmbed::Utils).to receive(:estimate_hubness_rust).and_return({ 'mean_hub_score' => 0.5 })
      ...
      it 'handles data with varying dimensions consistently' do
        ...
        allow(AnnEmbed::Utils).to receive(:estimate_intrinsic_dimension_rust).with(data_2d, 5).and_return(1.8)
        allow(AnnEmbed::Utils).to receive(:estimate_intrinsic_dimension_rust).with(data_10d, 5).and_return(7.2)
