...
hdbscan = AnnEmbed::Clustering::HDBSCAN.new(min_samples: 5, min_cluster_size: 5)
hdbscan.fit(data)
...
result = AnnEmbed::Clustering.kmeans(data, 3)
result = AnnEmbed::Clustering.hdbscan(data, min_samples: 5)